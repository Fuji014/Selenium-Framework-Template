...
public class TestDataHandler {
	...
	public static TestDataHandler loadTestData(Recordset record) throws Exception {
		...
		testDataHandler.make = record.getField("Make Select");
		...
		testDataHandler.priceOption = record.getField("Price Option");
		...
		testDataHandler.successMessage = record.getField("Success Message");
